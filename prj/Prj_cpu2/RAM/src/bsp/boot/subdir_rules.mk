...
src/bsp/boot/F2837xD_CodeStartBranch.obj: /home/cg/Work/McMaster/Prj_TMS320F28379D/Prj_Controller/src/bsp/boot/F2837xD_CodeStartBranch.asm $(GEN_OPTS) | $(GEN_HDRS)
	...
	"/home/cg/Apps/CCSV7/ccsv7/tools/compiler/ti-cgt-c2000_16.9.4.LTS/bin/cl2000" -v28 -ml -mt --cla_support=cla1 --float_support=fpu32 --tmu_support=tmu0 --vcu_support=vcu2 -O2 --include_path="/home/cg/Work/McMaster/Prj_TMS320F28379D/Prj_Controller/Prj_cpu2" --include_path="/home/cg/Apps/CCSV7/ccsv7/tools/compiler/ti-cgt-c2000_16.9.4.LTS/include" --diag_warning=225 --diag_wrap=off --display_error_number --preproc_with_compile --preproc_dependency="src/bsp/boot/F2837xD_CodeStartBranch.d_raw" --obj_directory="src/bsp/boot" $(GEN_OPTS__FLAG) "$(shell echo $<)"
