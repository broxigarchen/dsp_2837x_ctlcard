 ...
 *@ Notice
    !!!TIMER2 is default enabled in Core 1
 *@ Explains
 ...
 *@ Explains
    EPWMx_ISR_RT       interrupt routing, connect to which kernel, some of the options
 ...
 *@ Explains
    ...
    UART_x_PARITY                    even/odd check,
                                     select from:   0,  disable
                                                    1,  odd check
                                                    2,  even check
    UART_x_ISR_RT                    interrupt routing, connect to which kernel, some of the options
                                     are not availible, check the user manual when changing
                                    select from: 0,  cpu 1
                                                 1,  cpu 2
                                                 2,  cla 1
 ...
 *@ Explains
    ...
    SPI_x_SHRED                     how many bytes triggered receive interrupt
                                     select from  1 - 31
    SPI_x_ISR_RT                    interrupt routing, connect to which kernel, some of the options
